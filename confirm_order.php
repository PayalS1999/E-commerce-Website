...
mysqli_select_db($conn, "kalakriti") or die("Couldn't select DB");
ob_start();
session_start();
...
//triming name
	try {
		...
		// Check if email already exists
						...
						$result = mysqli_query($conn, "SELECT * FROM orders WHERE uid='$user'");
	...
	<div class="homepageheader">
		...
		$result = mysqli_query($conn, "SELECT * FROM user WHERE id='$user'");
			$get_user_email = mysqli_fetch_assoc($result);
				...
				echo '<input type="hidden" id="amount" name="amount" value="Rs.'.$_SESSION['total'].'">';
