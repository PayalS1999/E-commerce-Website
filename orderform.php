...
<body style="background-image: url(image/homebackgrndimg1.jpg);">
	...
	<div class="categolis">
		<table>
			<tr>
				<th>
					<a href="OurProducts/WallDecor.php" style="text-decoration: none;color:#040403 ;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Wall Decors</a>
				</th>
				<th><a href="OurProducts/Candles.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Candles</a></th>
				<th><a href="OurProducts/Pottery.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Pottery</a></th>
			</tr>
		</table>
	</div>
	...
	$result = mysqli_query($conn, "SELECT * FROM user WHERE id='$user'");
		$get_user_email = mysqli_fetch_assoc($result);
			...
			echo "<form action='/kalakriti/epayments/pay/index.php' method='POST' class='registration'>";
			echo '<input type="hidden" id="amount" name="amount" value="'.$amt.'">';
			echo '<div><input style="font-face: Comic Sans MS; font-size: larger; color: teal; background-color: #FFFFC0; border: 3pt ridge lightgrey" ; onclick="document.location.href=http://localhost/kalakriti/epayments/pay/index.php" name="order" class="uisignupbutton signupbutton" type="submit" value="Pay">
				</div>';
			echo "</form>";
					...
					echo '
						...
						<div>
							<form action="" method="POST" class="registration">
								...
								<h3 style="color:red;font-size:18px; padding: 5px;">Accepting online payments Only</h3>
									<div>
										<td>
											<input name="fullname" placeholder="your name" required="required" class="email signupbox" type="text" size="30" value="'.$uname_db.'"readonly>
										</td>
									</div>

									<div>
										<td>
											<input name="lastname" placeholder="Your last name" required="required" class="email signupbox" type="text" size="30" value="'.$ulast_db.'"readonly>
										</td>
									</div>
									...
									<div>
									<td>
											<input name="mobile" placeholder="Your mobile number" required="required" class="email signupbox" type="text" size="30" value="'.$umob_db.'"readonly>
										</td>
									</div>
									<div>
										<td>
											<input name="address" id="password-1" required="required"  placeholder="Write your full address" class="password signupbox " type="text" size="30" value="'.$uadd_db.'"readonly>
										</td>
									</div>
									...
									<div>
									<td>
											<input name="amount"  required="required" class="email signupbox" type="text" size="30" value="Rs.'.$quan * $price.'"readonly>
										</td>
									</div>
									...
									<div>
										<input style="font-face: Comic Sans MS; font-size: larger; color: teal; background-color: #FFFFC0; border: 3pt ridge lightgrey" ; onclick="document.location.href=epayments/pay/index.php" name="order" class="uisignupbutton signupbutton" type="submit" value="Confirm Order">
									</div>
