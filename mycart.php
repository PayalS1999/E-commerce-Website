	...
	<div style="margin-top: 20px; padding: 0 10%;">
		...
		$result = mysqli_query($conn, "SELECT * FROM user WHERE id='$user'");
			$get_user_email = mysqli_fetch_assoc($result);
				...
				echo '<h3 style="color:#169E8F;font-size:35px;"> Total: Rs. '.$_SESSION['total'].' </h2>';
				//	echo '<h3 style="color:#169E8F;font-size:45px;"> Total: Rs. '.$amount.'</h2>';
						...
						echo '
							...
							<div class="signupform_text"></div>
								...
								<form action="confirm_order.php" method="POST" class="registration">
									...
									<h3 style="color:red;font-size:18px; padding: 5px;">Accepting online payments Only</h3>
										...
										<div>
										<td>
												<input name="amount"  required="required" class="email signupbox" type="text" size="30" value="Rs.'.$_SESSION['total'].'"readonly>
											</td>
										</div>
										...
										<div>
											<input style="font-face: Comic Sans MS; font-size: larger; color: teal; background-color: #FFFFC0; border: 3pt ridge lightgrey" ; onclick = "confirm_order.php" ; name="order" class="uisignupbutton signupbutton" type="submit" value="Confirm Order">
										</div>
