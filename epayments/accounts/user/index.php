...
<div>
	<div class="float-container">
		<div class="float-child">
			<center>
				<div class="usercard" >
					...
					<img src="../../resources/images/john_doe.png" height="40%" width="60%" walt="John" >
		...
		<div class="float-child ">
			<div class="services">
				<ul>
					<li><a href="/kalakriti/epayments/pay/index.php">Pay</a></li>
					<li><a href="/kalakriti/epayments/accounts/add_money_to_wallet">Add Money to Wallet</a></li>
					<li><a href="/kalakriti/epayments/accounts/transfer_money_to_bank">Transfer Money to Bank</a></li>
				</ul>
			</div>
		</div>
		<div class="float-child">
			<div class="balance" >
				<center>
					...
					<img src="/kalakriti/epayments/resources/images/rupee.png" height="10%" width="20%">
					<h1 id="amount"></h1>
				</center>
			</div>
		</div>
