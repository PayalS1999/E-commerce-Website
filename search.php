...
<body>
	...
	<div class="categolis">
		<table>
			<tr>
				<th>
					<a href="OurProducts/Candles.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Candles</a>
				</th>
				...
				<th><a href="OurProducts/WallDecor.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Wall Decor</a></th>
				</tr>
		</table>
	</div>
	<div style="padding: 30px 120px; font-size: 25px; margin: 0 auto; display: table; width: 98%;">
		...
		<?php 
			if (isset($_GET['keywords']) && $_GET['keywords'] != ""){
				$search_value = trim($_GET['keywords']);
				$getposts = mysqli_query($conn,"SELECT * FROM products WHERE pName like '%$search_value%'  ORDER BY id DESC") or die(mysqli_error());
